        ...
        return {
            ...
            defineEntityType: function (key, descriptor) {
                if (this.defaults[key]) {
                    throw 'The entity type "' + key + '" is already defined!';
                }

                if (alchemy.isFunction(descriptor.getComponents)) {
                    this.defaults[key] = alchemy('Immutatio').makeImmutable(descriptor.getComponents());
                }
            ...
            setEntityDefaults: function (key, components) {
                this.defaults[key] = alchemy('Immutatio').makeImmutable(components);
            },
