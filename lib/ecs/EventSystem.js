module.exports = function (alchemy) {
    ...
    alchemy.formula.add({
        ...
        return {
             ...
             */
            update: function () {
                var delegates = this.entities.getAllComponentsOfType('delegatedEvents');
                alchemy.each(delegates, this.updateDelegatedEvents, this);

                var events = this.entities.getAllComponentsOfType('events');
                var ids = alchemy.each(events, this.delegateEvents, this);
            ...
            /** @private */
            updateDelegatedEvents: function (cfg) {
            ...
            getEventHandler: function (entityId, cfg) {
                ...
                return function (event) {
                    ...
                    if (cfg.message) {
                        messages.trigger(cfg.message, state.current && state.current.val());
                    }
                };
            },
        };
