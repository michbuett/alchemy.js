    ...
    alchemy.formula.add({
        ...
        return {
            ...
            createFromState: function (entityId, cfg, currentChildren) {
                ...
                var strategy = this.getStrategy(cfg);
            ...
            /** @private */
            getStrategy: function (cfg) {
                if (alchemy.isFunction(cfg.strategy)) {
                    return cfg.strategy;
                }

                if (this.strategies[cfg.strategy]) {
                    return this.strategies[cfg.strategy];
                }

                throw 'Cannot determine strategy for dynamic entity creation!';
            },
        };
    });
};
