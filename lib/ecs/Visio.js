module.exports = function (alchemy) {
    ...
    alchemy.formula.add({
        ...
        return {
            ...
            update: function () {
                var renderConfigs = this.entities.getAllComponentsOfType('dom');
                var placeholder = {};
                var rootNodes = [];
            ...
            linkChildren: function (cfg, entityId) {
                var dom = this.entities.getComponent(entityId, 'dom');
                if (!dom) {
                    return;
                }

                cfg.array[cfg.index] = dom.current;
            },
