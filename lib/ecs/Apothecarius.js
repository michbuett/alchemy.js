module.exports = function (alchemy) {
    ...
    alchemy.formula.add({
        ...
        return {
             ...
             * @param {Object} componentDefaults The defaults
             */
            defineEntityType: function (entityType, componentDefaults) {
                if (this.defaults[entityType]) {
                    throw 'The entity type "' + entityType + '" is already defined!';
                }

                this.defaults[entityType] = componentDefaults;
            },
            ...
            /**
             * Returns a collection containing all components of a give type
             *
             * @param {String} type The component identifier
             * @return {alchemy.core.Collectum} A collection containing all
             *      components of the requested type
             */
