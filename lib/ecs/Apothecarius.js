module.exports = function (alchemy) {
     ...
     */
    alchemy.formula.define('alchemy.ecs.Apothecarius', [
        ...
        return alchemy.extend(MateriaPrima, {
            ...
            contains: function (entityId) {
                return alchemy.isObject(this.entities[entityId]);
            },
            ...
            removeAllEntities: function () {
                alchemy.each(Object.keys(this.entities), this.removeEntity, this);
            },
            ...
            removeComponent: function (entityId, type) {
                var entity = alchemy.isObject(entityId) ? entityId : this.entities[entityId];
            ...
            getAllComponentsOfType: function (type) {
                return alchemy.each(this.components[type], filterExisting);
            },
            ...
            setComponent: function (entityId, key, cfg) {
                ...
                if (cmp) {
                    ...
                    // add new component
                    cmp = Immutatio.makeImmutable(cfg);
