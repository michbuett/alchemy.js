    ...
    alchemy.formula.add({
        ...
        return {
            ...
            updateEntity: function (renderCfg, index, placeholder) {
                ...
                var renderer = this.findRenderer(renderCfg);
            ...
            findRenderer: function (cfg) {
                ...
                throw 'Cannot determine renderer for entity "' + cfg.id + '"!';
            },
            ...
            draw: function (renderCfg) {
                ...
                var root = renderCfg.root || document.getElementById(renderCfg.id);
                if (!root) {
                    return;
                }
