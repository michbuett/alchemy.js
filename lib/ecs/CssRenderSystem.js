module.exports = function (alchemy) {
    ...
    alchemy.formula.define('alchemy.ecs.CssRenderSystem', [
        ...
        /**
         * The CSS render context
         *
         * @class
         * @name RenderContext
         */
        function RenderContext(entityId, state) {
        ...
        return alchemy.extend(MateriaPrima, {
             ...
             */
            update: function () {
                var staticCss = this.entities.getAllComponentsOfType('staticCss');
                alchemy.each(staticCss, this.updateStaticCss, this);
            ...
            /** @private */
            updateStaticCss: function (cfg, entityId) {
                this.setRules(cfg.rules);
                this.entities.removeComponent(entityId, 'staticCss');
            },
            ...
            updateDynamicCss: function (cfg, entityId) {
                ...
                var rules = cfg.renderer.call(null, new RenderContext(entityId, currentState));
