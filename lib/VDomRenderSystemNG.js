module.exports = (function () {
     ...
     *
     * @class
     * @name alchemy.ecs.VDomRenderSystemNG
     */
    return coquoVenenum({
        /** @lends alchemy.ecs.VDomRenderSystemNG.prototype */
        ...
        updateEntity: function (entity, entityId) {
            var currentTree = entity && entity.vdom_ng;
        ...
        checkChildEntityCache: function (childEntities) {
            ...
            for (var i = 0, l = childEntities.length; i < l; i++) {
                var childEntityId = childEntities[i];
