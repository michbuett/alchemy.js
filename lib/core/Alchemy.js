    ...
    (function () {
        ...
        alchemy.defineGetter = function (obj, prop, getter, getterName) {
            ...
            if (getterName === false) {
                ...
                getterName = getterName || 'get' + prop.charAt(0).toUpperCase() + prop.substr(1, prop.length);
        ...
        alchemy.defineSetter = function (obj, prop, setter, setterName) {
            ...
            if (setterName === false) {
                ...
                setterName = setterName || 'set' + prop.charAt(0).toUpperCase() + prop.substr(1, prop.length);
