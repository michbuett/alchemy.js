...
(function () {
    ...
    alchemy.formula = (function () {
        ...
        return {
             ...
             */
            define: function (name, dependencies, potion) {
                alchemy.formula.add({
                    name: name,
    ...
    if (isNode) {
        ...
        alchemy.override(alchemy.formula, require('./../node/alchemy.formula.js')(alchemy));
    }
})();
