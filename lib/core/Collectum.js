        ...
        overrides: {
            ...
            insert: function (index, data, silent) {
                ...
                if (silent !== true) {
                     ...
                     *
                     * @param {Object} data
                     *      The event data providing the property <code>added</code>
            ...
            removeAt: function (index, silent) {
                ...
                delete this.keys[removedItem.id];
                ...
                if (silent !== true) {
                     ...
                     *
                     * @param {Object} data
                     *      The event data providing the property <code>removed</code>
