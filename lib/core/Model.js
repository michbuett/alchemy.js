...
(function () {
    ...
    /**
     * @class alchemy.core.Model
     * @extends alchemy.core.Oculus
     */
    alchemy.formula.add({
        name: 'alchemy.core.Model',
        alias: 'Model',
        ...
        overrides: {
             ...
             *
             * @param {String} key
             *      Optional; The attributebute key; leave empty to get all values
             *
             * @return Mixed
             *      The store value for the given key or all values if the key was
             *      omitted
             */
            get: function (key) {
                if (alchemy.isString(key)) {
